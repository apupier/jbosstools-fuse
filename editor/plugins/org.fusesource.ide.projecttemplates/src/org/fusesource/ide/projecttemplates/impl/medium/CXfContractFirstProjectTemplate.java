...
public class CXfContractFirstProjectTemplate extends AbstractProjectTemplate {
	...
	public TemplateCreatorSupport getCreator(NewProjectMetaData projectMetaData) {
		return new CXfContractFirstUnzipTemplateCreator();
	}
	
	private class CXfContractFirstUnzipTemplateCreator extends UnzipStreamCreator {

		private static final String TEMPLATE_FOLDER = "templates/medium/cxf-contract-first/";
		private static final String TEMPLATE_BLUEPRINT = "medium-fuse-cxf-contract-first-blueprint.zip";
		private static final String TEMPLATE_SPRING = "medium-fuse-cxf-contract-first-spring.zip";
		private static final String TEMPLATE_JAVA = "medium-fuse-cxf-contract-first-java.zip";
