...
public class FuseIntegrationProjectWizardTemplatePage extends WizardPage {
	...
	public void createControl(Composite parent) {
	    ...
	    btn_routesDSL = new Button(grp_dslSelection, SWT.RADIO);
	    btn_routesDSL.setText(Messages.newProjectWizardTemplatePageRoutesDSLLabel);
	    btn_routesDSL.setToolTipText(Messages.newProjectWizardTemplatePageRoutesDSLDescription);
	    btn_routesDSL.addSelectionListener(new SelectionAdapter() {
	    	/*
	    	 * (non-Javadoc)
	    	 * @see org.eclipse.swt.events.SelectionAdapter#widgetSelected(org.eclipse.swt.events.SelectionEvent)
	    	 */
	...
	private void validate() {
		if (btn_templateProject.getSelection() &&
			(list_templates.getSelection().isEmpty() || 
			 Selections.getFirstSelection(list_templates.getSelection()) instanceof CategoryItem)) {
			setPageComplete(false);
		} else {
