...
public class EIPMandatoryChildValidator implements IValidator {
	...
	public IStatus validate(Object value) {
		if(isChoiceComponent(value) && !hasChildren((CamelBasicModelElement)value)) {
			return ValidationStatus.error(Messages.choiceWithoutChild);
		}
	...
	protected boolean isChoiceComponent(Object value) {
